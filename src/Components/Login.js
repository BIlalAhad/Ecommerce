...
>
  ...
  <input className=' border-2 w-full border-gray-300 p-1 sm:p-2' autoComplete='off' type='password' placeholder='Password' name='Password' onChange={(e)=>setPassward(e.target.value)}/>
  </div>
